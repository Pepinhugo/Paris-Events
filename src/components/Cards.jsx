...
//Fonction pour récupérer les données sur la page d'accueil avec l'utilisation d'un fetch 
const Cards = () => {
  ...
  //Les Données récupérées et retournées par la fonction + bouton pour ajouter l'événement en favoris 
  //Animation sur la photo de la card
  return (
        ...
        <p>Le dernier événement publié :</p>
          ...
          {records && records.map((recordEvents) => 
            ...
            <div className='card' key={recordEvents.record.id}>
              ...
              <Animated animationIn="flipInY"><a href="Events.jsx"><img src= {recordEvents.record.fields.cover_url}/></a></Animated>
